    ...
    >
      ...
      <nav className="w-full flex  items-center px-8 py-5 bg-[#343A40]/50 backdrop-blur-md shadow-md h-20 relative z-10">
        ...
        <div className="flex gap-4 ml-auto">
          <button
            className="px-6 py-2 bg-[#495057] hover:bg-[#5c636a] transition-all duration-300  text-white font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-1"
      ...
      <div className="flex flex-wrap color- to-black justify-center gap-10 mt-14 px-6">
        {[
          ...
          <div
            key={idx}
            className="bg-white/30 backdrop-blur-md border border-white/30 hover:bg-white/30 transition-all duration-300 text-white p-8 rounded-2xl shadow-xl w-80 text-center cursor-pointer transform hover:-translate-y-2"
          >
